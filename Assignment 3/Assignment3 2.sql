...
*/
SELECT PCs.model FROM PCs WHERE PCs.model IN (SELECT Laptops.model FROM Laptops)
Union
SELECT Laptops.model from Laptops WHERE Laptops.model IN (SELECT Printers.model from Printers);
